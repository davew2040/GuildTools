...
namespace GuildTools.Migrations
{
    ...
    [Migration("20190430212723_Initial")]
            ...
            modelBuilder.Entity("GuildTools.EF.Models.StoredBlizzardModels.StoredPlayer", b =>
                {
                    ...
                    b.HasOne("GuildTools.EF.Models.PlayerAlt", "Alt")
                        .WithOne("Player")
                        .HasForeignKey("GuildTools.EF.Models.StoredBlizzardModels.StoredPlayer", "Id")
                        .HasPrincipalKey("GuildTools.EF.Models.PlayerAlt", "PlayerId")
                        .OnDelete(DeleteBehavior.Restrict);
