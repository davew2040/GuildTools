        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserRealm = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GuildProfile_AspNetUsers_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PendingAccessRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PendingAccessRequests_GuildProfile_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "GuildProfile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PendingAccessRequests_AspNetUsers_RequesterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_User_GuildProfilePermissions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PendingAccessRequests_Id",
                table: "PendingAccessRequests",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_PendingAccessRequests_ProfileId",
                table: "PendingAccessRequests",
                column: "ProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_PendingAccessRequests_RequesterId",
                table: "PendingAccessRequests",
                column: "RequesterId");
